...
public class AIAwardGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        inOutPathList.add(new DocProcess(routineIn1, appIn1, resIn1, outputPath1));
        inOutPathList.add(new DocProcess(routineIn2, appIn2, resIn2, outputPath2));
        inOutPathList.add(new DocProcess(routineIn3, appIn3, resIn3, outputPath3));
        inOutPathList.add(new DocProcess(routineIn4, appIn4, resIn4, outputPath4));
        inOutPathList.add(new DocProcess(routineIn5, appIn5, resIn5, outputPath5));
        inOutPathList.add(new DocProcess(routineIn6, appIn6, resIn6, outputPath6));
        inOutPathList.add(new DocProcess(routineIn7, appIn7, resIn7, outputPath7));
        inOutPathList.add(new DocProcess(routineIn8, appIn8, resIn8, outputPath8));
        ...
        try {
            for (int i = 0; i < inOutPathList.size(); ++i) {
                ...
                awardGen.generateAwardDoc(aApplication, routineContent, respondContent);
            }
